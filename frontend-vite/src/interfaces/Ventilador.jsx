...
function Modelo({ trigger }) {
  ...
  const group = useRef();
  const { scene, animations } = useGLTF("/models/Ventilador.glb");
...
// 🔵 PASOS PARA INSTALAR DISIPADOR
const pasosInstalar = [
  "Apagar completamente la computadora y desconectar el cable de corriente.",
  "Abrir el gabinete retirando el panel lateral.",
  "Ubicar el procesador (CPU) en la placa madre.",
  "Aplicar una pequeña cantidad de pasta térmica sobre el centro del procesador.",
  "Colocar el disipador sobre el procesador alineándolo con los soportes o anclajes.",
  "Asegurar el disipador utilizando los tornillos o clips correspondientes.",
  "Verificar que el disipador esté firmemente sujeto y en contacto con el procesador.",
  "Conectar el cable del ventilador del disipador al conector CPU_FAN de la placa madre.",
  "Cerrar el gabinete.",
  "Encender el equipo y verificar que el ventilador del disipador funcione correctamente."
];


// 🔴 PASOS PARA DESINSTALAR DISIPADOR
const pasosDesinstalar = [
  "Apagar completamente la computadora y desconectar el cable de corriente.",
  "Abrir el gabinete retirando el panel lateral.",
  "Ubicar el disipador instalado sobre el procesador.",
  "Desconectar el cable del ventilador del disipador de la placa madre.",
  "Aflojar o retirar los tornillos o clips que sujetan el disipador.",
  "Mover ligeramente el disipador para despegarlo de la pasta térmica.",
  "Levantar cuidadosamente el disipador del procesador.",
  "Limpiar los restos de pasta térmica del procesador y del disipador si es necesario.",
  "Retirar completamente el disipador del gabinete."
];
