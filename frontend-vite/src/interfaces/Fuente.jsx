...
function Modelo({ trigger }) {
  ...
  const group = useRef();
  const { scene, animations } = useGLTF("/models/Fuente.glb");
...
export default function Vision() {
 ...
 // 🔵 PASOS PARA INSTALAR FUENTE DE PODER
const pasosInstalar = [
  "Apagar completamente la computadora y desconectar todos los cables.",
  "Abrir el gabinete retirando el panel lateral.",
  "Ubicar el compartimento donde se instalará la fuente de poder.",
  "Insertar la fuente de poder en su lugar, asegurándose de que los orificios de los tornillos coincidan con los del gabinete.",
  "Atornillar la fuente firmemente al gabinete.",
  "Conectar el cable de alimentación principal ATX a la placa madre.",
  "Conectar el cable de alimentación del procesador (CPU) a la placa madre.",
  "Conectar los cables de alimentación a discos duros, SSDs y otros dispositivos según corresponda.",
  "Organizar los cables para mantener el interior limpio y evitar obstrucciones.",
  "Cerrar el gabinete.",
  "Conectar el cable de corriente y encender el equipo para verificar que la fuente funcione correctamente."
];

// 🔴 PASOS PARA DESINSTALAR FUENTE DE PODER
const pasosDesinstalar = [
  "Apagar completamente la computadora y desconectar el cable de corriente.",
  "Abrir el gabinete retirando el panel lateral.",
  "Desconectar todos los cables de alimentación que provienen de la fuente hacia la placa madre, CPU y dispositivos.",
  "Retirar los tornillos que sujetan la fuente de poder al gabinete.",
  "Sujetar la fuente firmemente.",
  "Extraer la fuente de poder cuidadosamente del gabinete.",
  "Cerrar el gabinete si ya no se va a instalar otra fuente."
];
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900/60 backdrop-blur-2xl p-8 rounded-3xl border border-slate-700/50 shadow-[0_0_40px_rgba(0,255,255,0.05)]">
          ...
          <div className="w-full h-[500px] rounded-2xl overflow-hidden border border-slate-700/50 shadow-inner">
            ...
            <Canvas camera={{ position: [-4, 2, -10], fov: 80 }}>
