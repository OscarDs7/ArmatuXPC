...
function Modelo({ trigger }) {
  ...
  const group = useRef();
  const { scene, animations } = useGLTF("/models/RAMS.glb");
...
export default function Vision() {
 ...
 // 🔵 PASOS PARA INSTALAR MEMORIA RAM
const pasosInstalar = [
  "Apagar completamente la computadora y desconectar el cable de corriente.",
  "Abrir el gabinete retirando el panel lateral.",
  "Ubicar las ranuras DIMM en la placa madre.",
  "Identificar la orientación correcta del módulo RAM (muesca guía).",
  "Abrir las pestañas laterales de la ranura.",
  "Alinear la memoria RAM con la ranura correspondiente.",
  "Insertar la memoria presionando firmemente hasta escuchar un clic.",
  "Verificar que las pestañas laterales se cierren automáticamente.",
  "Cerrar el gabinete.",
  "Encender el equipo y verificar que la RAM sea reconocida en la BIOS o sistema operativo."
];

// 🔴 PASOS PARA DESINSTALAR MEMORIA RAM
const pasosDesinstalar = [
  "Apagar completamente la computadora y desconectar el cable de corriente.",
  "Abrir el gabinete retirando el panel lateral.",
  "Ubicar el módulo de memoria RAM instalado.",
  "Separar cuidadosamente las pestañas laterales de la ranura DIMM.",
  "Esperar a que el módulo se eleve ligeramente.",
  "Sujetar la memoria por los bordes (evitar tocar los contactos dorados).",
  "Extraer la memoria RAM cuidadosamente.",
  "Guardar el módulo en una bolsa antiestática."
];
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900/60 backdrop-blur-2xl p-8 rounded-3xl border border-slate-700/50 shadow-[0_0_40px_rgba(0,255,255,0.05)]">
          ...
          <div className="w-full h-125 rounded-2xl overflow-hidden border border-slate-700/50 shadow-inner">
            ...
            <Canvas camera={{ position: [.2,.6,1], fov: 30 }}>
